package ttcnpm.g24.tuyendung.Searching;
        ...
        import ttcnpm.g24.tuyendung.Newsfeed.News;
        import ttcnpm.g24.tuyendung.Newsfeed.NewsfeedAdapter;
        import ttcnpm.g24.tuyendung.R;

public class CompanySearching extends Fragment {
    ...
    private String url = "http://jws-app-mobile.a3c1.starter-us-west-1.openshiftapps.com/ReturnPostForCompany";
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.company_news_feed_fragment,container,false);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        FloatingActionButton btn_refresh = view.findViewById(R.id.cpn_news_refresh);
    ...
    private void getNewsList() {
        ...
        try {
            jsonObject.put("userid",serializableNews.getCpnID() );
